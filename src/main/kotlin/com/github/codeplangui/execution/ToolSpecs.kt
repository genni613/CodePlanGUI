...
class ToolSpecs(
    ...
    val editFileExecutor = EditFileExecutor(fileChangeReview, inlineChangeHighlighter)
    val writeFileExecutor = WriteFileExecutor(fileChangeReview, inlineChangeHighlighter)
